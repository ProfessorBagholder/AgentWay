...
pub(super) const VERSION: &str = "19";
...
pub(super) fn payload(reservation_bytes: i64, max_video_bytes: i64) -> Value {
    json!({
        ...
        "handoff_delivery": {"mode":"pull_inbox","native_wake_available":false,"pickup_guaranteed":false,"recipient_checks_inbox":true,"sender_checks_result":true,"default_timeout_seconds":86400,"notification_stream":"/v1/agent-tasks/stream"},
