...
- Channel description: HTTP/MCP read and update with existing management consent, channel binding, stale-edit detection, preserved branding fields and verified readback. Guidance version 5. Mock tests cover authorization, preservation, uncertain-write reconciliation and readback mismatch; real content editing remains an agent/user operation.
